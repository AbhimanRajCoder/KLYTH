  ...
  return (
    <section className="relative w-full py-24 px-6 z-10 flex justify-center">
      ...
      <motion.div
        ...
        className="relative max-w-4xl w-full p-[1px] rounded-[3rem] overflow-hidden"
      >
        ...
        <div className="relative w-full h-full bg-[#1C1C1E]/90 backdrop-blur-3xl rounded-[calc(3rem-1px)] p-10 md:p-16 text-center flex flex-col items-center shadow-[0_40px_100px_rgba(0,0,0,0.8)] z-10">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <motion.a 
              ...
              className="group relative inline-block bg-klyth-olive text-klyth-cream font-sans font-medium text-sm tracking-wide py-5 px-16 rounded-full transition-shadow duration-500 shadow-[0_0_30px_rgba(74,93,35,0.3)] hover:shadow-[0_0_50px_rgba(74,93,35,0.6)]"
            >
              Drop us an email
              {/* Subtle inner shine */}
